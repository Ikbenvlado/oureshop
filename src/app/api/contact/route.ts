            ...
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td style="padding:10px 14px;background:#f8f4ff;border-radius:8px;margin-bottom:8px;">
                  ...
                  <p style="margin:4px 0 0;font-size:15px;color:#1f2937;font-weight:500;">${h(meno)}</p>
                </td>
              </tr>
              ...
              <tr>
                <td style="padding:10px 14px;background:#f8f4ff;border-radius:8px;">
                  ...
                  <p style="margin:4px 0 0;font-size:15px;color:#1f2937;font-weight:500;">${h(email)}</p>
                </td>
              </tr>
              <tr><td style="height:8px;"></td></tr>
              <tr>
                <td style="padding:10px 14px;background:#f8f4ff;border-radius:8px;">
                  ...
                  <p style="margin:4px 0 0;font-size:15px;color:#1f2937;line-height:1.6;white-space:pre-wrap;">${h(sprava)}</p>
                </td>
              </tr>
            </table>
            <p style="margin:24px 0 0;font-size:12px;color:#9ca3af;text-align:center;">
              Odpovedz priamo na tento email alebo kontaktuj zákazníka na <a href="mailto:${h(email)}" style="color:#7c3aed;">${h(email)}</a>
            </p>
          </td>
        </tr>
      </table>
      ...
      <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
        ...
        <tr>
          <td style="padding:40px 32px;text-align:center;">
            ...
            <p style="margin:0 0 8px;font-size:15px;color:#6b7280;">Dobrý deň, <strong style="color:#1f2937;">${h(meno)}</strong></p>
